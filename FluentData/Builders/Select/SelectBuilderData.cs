...
namespace FluentData
{
	public class SelectBuilderData : BuilderData
	{
        ...
        public IList<object> ObjectParameters { get; set; }
        public IList<DbCommandParameter> NamedParameters { get; set; }
        ...
        public SelectBuilderData(IDbCommand command, string objectName) : base(command, objectName)
		{
            ...
            ObjectParameters = new List<object>();
            NamedParameters = new List<DbCommandParameter>();
		}
